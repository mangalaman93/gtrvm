/* about.c - test if multiple calls on about to modify change the behavior of aborting */
...
int main(int argc, char **argv)
{
     ...
     if ((int)trans2>0){printf("Error:editing same segment  twice at the same time");}
     rvm_about_to_modify(trans, seg, 0, 100);
